(function (root, factory) {
  ...
  const SCRIPT_SOURCES = Object.freeze([
    ...
    Object.freeze({ key: 'accounting-core', src: '../assets/app-core.js?v=20260902-app1' }),
    Object.freeze({ key: 'accounting-ui', src: '../assets/accounting-ui.js?v=20260902-app1' }),
  ...
  async function mount(container, context) {
    if (!initialized) {
      container.innerHTML = ACCOUNTING_TEMPLATE;
