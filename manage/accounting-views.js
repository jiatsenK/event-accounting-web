(function (root, factory) {
  ...
  function templateWithAccountingPanels() {
    ...
    return ACCOUNTING_TEMPLATE.replace(marker, BUDGET_PANEL + marker)
      ...
      .replace('<tbody id="expenseRows"><tr><td colspan="10" class="empty">讀取中…</td></tr></tbody></table></div>\n    </div>\n  </section>',
        '<tbody id="expenseRows"><tr><td colspan="10" class="empty">讀取中…</td></tr></tbody></table></div>\n    </div>' + advances + '\n  </section>');
  }
